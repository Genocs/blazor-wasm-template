...
```bash
dotnet new --install Genocs.BlazorWasm.Template::2.3.1
```
...
**Genocs.BlazorWasm.Template::2.3.1 is compatible only with Genocs.Microservice.Template::2.3.0 and above.**
